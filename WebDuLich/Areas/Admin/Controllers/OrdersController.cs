...
namespace WebDuLich.Areas.Admin.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var orders = db.Orders.Include(o => o.Customer).Include(o => o.Info);
        ...
        public ActionResult Create([Bind(Include = "Id,InfoId,CustomerId,OrderDate,Address,Description")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,InfoId,CustomerId,OrderDate,Address,Description")] Order order)
        {
            if (ModelState.IsValid)
            {
